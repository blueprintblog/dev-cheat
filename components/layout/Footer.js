      ...
      <div className="footer-content max-w-7xl mx-auto px-5 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left">
          ...
          <Link
            ...
            className="group inline-flex items-center justify-center px-6 py-3 backdrop-blur-sm outline-1 rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-lg bg-gradient-to-r from-orange-500/20 to-yellow-500/20 outline-orange-300/30 text-white hover:from-orange-500/30 hover:to-yellow-500/30 w-full md:w-auto">
            <div className="w-5 h-5 shrink-0 flex items-center justify-center mr-3">
              <svg
                ...
                fill="currentColor">
                <path
                  d="M22.0672 8.1281 22.0437 8.11426 21.9893 8.09766C22.0112 8.11614 22.0386 8.12685 22.0672 8.1281z"
                  fill="currentColor"></path>
                <path
                  d="M22.4111 10.5781 22.3848 10.5855 22.4111 10.5781z"
                  fill="currentColor"></path>
                <path
                  d="M22.0735 8.11128C22.0708 8.11093 22.0681 8.11029 22.0655 8.10938 22.0654 8.11115 22.0654 8.11293 22.0655 8.1147 22.0685 8.11432 22.0712 8.11313 22.0735 8.11128z"
                  fill="currentColor"></path>
                <path
                  d="M22.3877 10.5647 22.4274 10.5421 22.4421 10.5338 22.4555 10.5195C22.4303 10.5304 22.4074 10.5457 22.3877 10.5647z"
                  fill="currentColor"></path>
                <path
                  d="M22.1334 8.1762 22.0947 8.1393 22.0684 8.125C22.0825 8.14993 22.1058 8.16832 22.1334 8.1762z"
                  fill="currentColor"></path>
                <path
                  ...
                  fill="currentColor"></path>
                <path
                  d="M18.0497 30.8309C18.0497 30.7958 18.0326 30.8023 18.0368 30.9268 18.0368 30.9167 18.0409 30.9065 18.0428 30.8969 18.0451 30.8747 18.0469 30.853 18.0497 30.8309z"
                  fill="currentColor"></path>
                <path
                  ...
                  fill="currentColor"></path>
                <path
                  d="M8.39845 32.2145C8.37496 32.1941 8.34619 32.1807 8.31543 32.1758 8.34034 32.1878 8.36524 32.1998 8.38185 32.209L8.39845 32.2145z"
                  fill="currentColor"></path>
                <path
                  d="M7.50541 31.3533C7.50173 31.317 7.49058 31.2818 7.47266 31.25 7.48535 31.2831 7.49598 31.317 7.50448 31.3515L7.50541 31.3533z"
                  fill="currentColor"></path>
                <path
                  d="M13.5278 15.9814C12.2963 16.5086 10.8987 17.1064 9.08736 17.1064 8.32963 17.1048 7.57558 17.0009 6.8457 16.7973L8.09845 29.6592C8.14279 30.1968 8.38769 30.698 8.78452 31.0634 9.18134 31.4288 9.70106 31.6316 10.2405 31.6315 10.2405 31.6315 12.0167 31.7237 12.6094 31.7237 13.2474 31.7237 15.1601 31.6315 15.1601 31.6315 15.6995 31.6315 16.2191 31.4286 16.6158 31.0633 17.0125 30.6979 17.2574 30.1967 17.3017 29.6592l1.3418-14.2129C18.0439 15.2415 17.4387 15.1055 16.7565 15.1055 15.5767 15.105 14.626 15.5114 13.5278 15.9814z"
                  fill="#FD0"></path>
                <path
                  d="M2.96582 10.5039l.02122.0198L3.00088 10.532C2.99022 10.5215 2.97847 10.512 2.96582 10.5039z"
                  fill="currentColor"></path>
                <path
            ...
            <span className="font-semibold leading-none">Buy Me a Coffee</span>
          </Link>
        </div>
      </div>
