...
import { htmlCommands } from '@/data/html-data';
  ...
  return (
    <>
      ...
      <CardHeader
        ...
        description_1={
          <>
            <strong>HTML5</strong> é a quinta versão do HyperText Markup
            Language, a linguagem de marcação padrão para criar páginas web.
            HTML5 introduziu elementos semânticos, multimídia nativa e APIs
            poderosas para aplicações web modernas.
          </>
        }
        description_2={
          <>
            • Estrutura semântica e acessível <br /> • Suporte nativo para
            multimídia <br /> • APIs para aplicações ricas <br /> •
            Compatibilidade cross-browser <br /> • Otimizado para dispositivos
            móveis
          </>
        }
        description_3={
          <>
            • Estrutura de páginas web <br /> • Formulários interativos <br /> •
            Conteúdo multimídia <br /> • Aplicações web progressivas <br /> •
            Design responsivo
          </>
        }>
        <>
          <strong className="text-[#e34c26] text-[18px]">
            💡 Onde você vai usar:
          </strong>
          <div className="where-grid">
            ...
            <div className="where-item">
              ...
              <br />
              <span className="opacity-80 text-base">PWA, Apps Híbridos</span>
            </div>
            <div className="where-item">
              ⚡ <strong>Modern</strong>
              <br />
              <span className="opacity-80 text-base">Semântico, Acessível</span>
            </div>
            <div className="where-item">
              🎨 <strong>Design</strong>
              <br />
              <span className="opacity-80 text-base">Estrutura, Layout</span>
            </div>
          </div>
        </>
      </CardHeader>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <SearchBar
          ...
          placeholder="Buscar comandos HTML..."
          className="mb-6"
        />
